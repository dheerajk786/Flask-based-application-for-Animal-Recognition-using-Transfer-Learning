...
@app.route('/predict',methods=['GET','POST'])  #it is decorator
@login_required
def uploadpredict():
   if request.method == 'POST':
         print("yeah")
...
# check if the post request has the file part
        ...
        # submit a empty part without filename
         ...
         if file :
            ...
            print(tresult)
            print(lresult)
            return render_template("animal_prediction.html",image=impath,result1=tresult,result2=lresult)
